<template>
  <div class="flex items-center justify-center">
    <div class="bg-gray-800 p-8 rounded shadow-md  w-full max-w-md">
      <h2 class="text-2xl font-semibold text-center text-white mb-6">Register</h2>
      <form @submit.prevent="onSubmit">
        ...
        <div class="mb-4">
          <label for="username" class="block text-sm font-medium text-gray-200 mb-2">Email:</label>
        ...
        <div class="mb-2">
          <button type="submit" 
          class="w-full bg-lime-400 text-white py-3 rounded hover:bg-lime-500 focus:outline-none focus:ring-2 focus:ring-lime-400">Register</button>
        </div>
      </form>
