<template>
  <div class="p-6 text-center">
    ...
    <h2 class="mt-2 summary-subtitle">
      <span>Stock: </span><router-link :to="`/stocks/${transactionIdData?.ticker}`" class="ticker-link">{{ transactionIdData?.ticker }}</router-link>
    </h2>
    ...
    <form @submit.prevent="" class="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div class="">
        ...
        <input
          ...
          class="input-style"
          :placeholder="
            transactionIdData ? `Fee: ${transactionIdData.fee}` : 'Loading..'
          "
        />
      </div>
      <div class="">
