<template>
  <aside class="sidebar-style p-4" :class="isSidebarOpen ? 'w-80' : 'w-24'">
    <div class="relative">
      <!-- App Icon -->
...
.side-icons {
  /* Change this! */
  @apply text-blue-600 dark:text-lime-400 w-14 h-14 group-hover:stroke-cyan-300 stroke-lime-400;
  /* color: #ffadff;
  width: 24px;
  height: 24px;*/
  stroke-width: 1.5px;
